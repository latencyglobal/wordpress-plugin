...
* 🔔 **Instant Alerts** - Get notified via email, Slack, webhooks, or PagerDuty when issues occur
* 📊 **Detailed Analytics** - View response times, uptime percentages, and performance trends
* 🔒 **SSL Monitoring** - Get alerts before your SSL certificate expires
...
* `[latency_uptime]` - Show an uptime badge
* `[latency_uptime style="minimal"]` - Minimal text display
* `[latency_uptime style="detailed"]` - Detailed stats
...
* **More global locations** - 110+ PoPs vs. typical 5-10
* **Detailed latency breakdown** - See DNS, TLS, and TTFB timings
* **GeoDNS integration** - Automatic traffic routing (Pro+)
...
* Verify your API key
* Create and manage monitors for your site
...
* Asia (Singapore, Japan, India, etc.)
